...
import br.com.lucolimac.barkscanner.cadastro.CadastroUsuario;
...
//        }
    ...
    private boolean isPasswordValid(String password) {
        //TODO: Replace this with your own logic
        return password.length() > 8 && containsDigit(password) && containsLowerCase(password) && containsUpperCase(password);
    }
...
//    }
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        //Create adapter to tell the AutoCompleteTextView what to show in its dropdown view.
