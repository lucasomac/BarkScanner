...
import br.com.lucolimac.barkscanner.adapter.AdapterCao;
import br.com.lucolimac.barkscanner.model.Cachorro;

public class CachorroActivityRecycler extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private RecyclerView recyclerCao;
    private RecyclerView.LayoutManager layoutManagerCao;
    private RecyclerView.Adapter mAdapterCao;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recycler_cao);

        recyclerCao = findViewById(R.id.recycler_cao);
        layoutManagerCao = new LinearLayoutManager(this);
        recyclerCao.setLayoutManager(layoutManagerCao);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapterCao = new AdapterCao(cachorros, CachorroActivityRecycler.this);
                recyclerCao.setAdapter(mAdapterCao);
                layoutManagerCao = new LinearLayoutManager(CachorroActivityRecycler.this, RecyclerView.VERTICAL, false);

                recyclerCao.setLayoutManager(layoutManagerCao);
                recyclerCao.addItemDecoration(new DividerItemDecoration(CachorroActivityRecycler.this, DividerItemDecoration.VERTICAL));
...
//                        startActivity(new Intent(CachorroActivityRecycler.this, Gravador.class));
//                        return true;
//                    case R.id.action_cachorro:
//                        startActivity(new Intent(CachorroActivityRecycler.this, CadastroCachorro.class));
//                        return true;
...
//        navigationView.setNavigationItemSelectedListener(this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_inicio) {
            ...
            finish();
            startActivity(new Intent(this, CachorroActivityRecycler.class));
